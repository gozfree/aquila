...
struct protocol {
    const char *name;
    int (*open)(struct protocol_ctx *c, const char *url, struct media_encoder *media, void *conf);
...
struct protocol_ctx *protocol_open(const char *url, struct media_encoder *media, void *conf);
