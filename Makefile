...
LDFLAGS	+= -L/usr/local/lib/gear-lib -lposix -ldebug -llog -lconfig -lgevent -ltime -lrtsp -ldict -lfile -lvector -lsock
LDFLAGS	+= -L/usr/local/lib/gear-lib -lthread -lrpc -lhash -lworkq -luvc -luac -lmedia-io -ldarray -lmp4
